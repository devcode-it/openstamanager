                    ...
                    <!-- Navbar Left Menu -->
                     ...
                     <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="'.base_url().'/bug.php" class="tip nav-button" title="'.tr('Segnalazione bug').'">
                                <i class="fa fa-bug"></i>
                            </a></li>

                            <li><a href="'.base_url().'/log.php" class="tip nav-button" title="'.tr('Log accessi').'">
                            ...
                            <li><a href="'.base_url().'/index.php?op=logout" onclick="sessionStorage.clear()" class="bg-red tip" title="'.tr('Esci').'">
