...
$query .= ' FROM an_referenti LEFT JOIN an_mansioni ON an_referenti.id_mansione=an_mansioni.id WHERE id_anagrafica IN('.implode(',', array_map(prepare(...), $idanagrafiche)).') ';
