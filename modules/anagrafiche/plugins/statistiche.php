        ...
        <div class="col-md-4">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    '.( count($rsi) > 0 ? '<span class="info-box-text pull-right"><a href="'.$rootdir.'/controller.php?id_module='.Modules::get('Ordini cliente')['id'].'&search_Cliente='.$rsi[0]['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '' ).'
                    <br class="clearfix">
                    <span class="info-box-number">
                        <big>'.count($rsi).'</big><br>
        ...
        <div class="col-md-4">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    '.( count($rsi) > 0 ? '<span class="info-box-text pull-right"><a href="'.$rootdir.'/controller.php?id_module='.Modules::get('Interventi')['id'].'&search_Cliente='.$rsi[0]['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '' ).'
                    <br class="clearfix">
                    <span class="info-box-number">
                        <big>'.count($rsi).'</big><br>
...
// Ddt in uscita
$rsi = $dbo->fetchArray("SELECT id, data, ragione_sociale FROM dt_ddt INNER JOIN an_anagrafiche ON dt_ddt.idanagrafica=an_anagrafiche.idanagrafica WHERE idtipoddt IN(SELECT id FROM dt_tipiddt WHERE dir='entrata') AND dt_ddt.idanagrafica=".prepare($id_record));
        ...
        <div class="col-md-4">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    '.( count($rsi) > 0 ? '<span class="info-box-text pull-right"><a href="'.$rootdir.'/controller.php?id_module='.Modules::get('Ddt in uscita')['id'].'&search_Cliente='.$rsi[0]['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '' ).'
                    <br class="clearfix">
                    <span class="info-box-number">
                        <big>'.count($rsi).'</big><br>
...
// Fatture di vendita
$rsi = $dbo->fetchArray("SELECT id, data, ragione_sociale FROM co_documenti INNER JOIN an_anagrafiche ON co_documenti.idanagrafica=an_anagrafiche.idanagrafica WHERE idtipodocumento IN(SELECT id FROM co_tipidocumento WHERE dir='entrata') AND co_documenti.idanagrafica=".prepare($id_record));
        ...
        <div class="col-md-4">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    '.( count($rsi) > 0 ? '<span class="info-box-text pull-right"><a href="'.$rootdir.'/controller.php?id_module='.Modules::get('Fatture di vendita')['id'].'&search_Cliente='.$rsi[0]['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '' ).'
                    <br class="clearfix">
                    <span class="info-box-number">
                        <big>'.count($rsi).'</big><br>
