...
$numero_documenti = $dbo->fetchNum('SELECT id FROM dt_ddt WHERE id_aspetto_beni='.prepare($id_record).'

UNION SELECT id FROM co_documenti WHERE id_aspetto_beni='.prepare($id_record));
