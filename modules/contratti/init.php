...
if (isset($id_record)) {
    $record = $dbo->fetchOne('SELECT *,
       ...
       (SELECT fatturabile FROM co_staticontratti WHERE id=id_stato) AS fatturabile,
       (SELECT pianificabile FROM co_staticontratti WHERE id=id_stato) AS pianificabile,
