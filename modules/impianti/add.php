...
$(document).ready(function () {
    ...
    $('#id_marca_add').change(function() {
        ...
        if($(this).val()){
            ...
            modello.parent().find(".input-group-append button").attr("onclick", originalModello ? originalModello.replace(/id_original=\d*/, "id_original=" + $(this).val()) : "openModal('<?php echo tr('Aggiungi modello'); ?>', '<?php echo base_path_osm(); ?>/add.php?id_module=<?php echo $id_modulo_marca_impianti; ?>&id_original=" + $(this).val() + "')");
        }
        else {
