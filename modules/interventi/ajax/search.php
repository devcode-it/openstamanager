...
$fields = [
    ...
    'Data intervento' => 'COALESCE((SELECT MIN(orario_inizio) FROM in_interventi_tecnici WHERE id_intervento=in_interventi.id), in_interventi.data_richiesta)',
...
$query = 'SELECT in_interventi.*,
    COALESCE(
        (SELECT MIN(orario_inizio) FROM in_interventi_tecnici WHERE id_intervento=in_interventi.id),
