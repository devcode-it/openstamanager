...
$rss = $dbo->fetchArray('SELECT completato AS flag_completato FROM in_statiintervento WHERE id = (SELECT id_stato FROM in_interventi WHERE id='.prepare($id_record).')');
