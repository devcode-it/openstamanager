...
<form action="" method="post" id="edit-form">
	...
	<div class="card card-primary">
		...
		<div class="card-body">
			...
			<div class="row">
				<div class="col-md-12">
					{[ "type":"select", "multiple": "1", "label":"'.tr('Clienti').'", "ajax-source": "clienti", "name": "id_anagrafica[]", "value": "'.$anagrafiche.'" ]}
				</div>
			</div>
...
<script>
	...
	$(document).ready(function(){
		const table = $("#tablelistini").DataTable({
			...
			serverSide: true,
			ajax: {
				url: "'.Module::where('name', 'Listini cliente')->first()->fileurl('ajax/table.php').'?id_listino='.$id_record.'",
				type: "GET",
				dataSrc: "data",
			},
			searchDelay: 500,
