        ...
        if (sizeof($records) > 0) {
            for ($i = 0; $i < sizeof($records); ++$i) {
                ...
                if ($lat != '0.00000000' && $lng != '0.00000000') {
                    ...
                    $descrizione .= '<i class="fa fa-user"></i> <b>Ragione sociale</b>:  <a href="'.$rootdir.'/editor.php?id_module='.(new Module())->getByField('title', 'Anagrafiche', Models\Locale::getPredefined()->id).'&id_record='.$records[$i]['id'].'" target="_blank" > '.$records[$i]['ragione_sociale'].' <i class="fa fa-external-link"></i> </a>'."\n<br>";
