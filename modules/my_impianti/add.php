...
?><form action="editor.php?id_module=$id_module$" method="post">
	...
	<div class="row">
		<div class="col-md-4">
			{[ "type": "text", "label": "<?php echo _('Matricola'); ?>", "name": "matricola", "required": 1, "class": "text-center", "value": "" ]}
		</div>
		...
		<div class="col-md-6">
			{[ "type": "select", "label": "<?php echo _('Tecnico'); ?>", "name": "idtecnico", "values": "query=SELECT an_anagrafiche.idanagrafica AS id, ragione_sociale AS descrizione FROM an_anagrafiche INNER JOIN (an_tipianagrafiche_anagrafiche INNER JOIN an_tipianagrafiche ON an_tipianagrafiche_anagrafiche.idtipoanagrafica=an_tipianagrafiche.idtipoanagrafica) ON an_anagrafiche.idanagrafica=an_tipianagrafiche_anagrafiche.idanagrafica WHERE descrizione='Tecnico' AND deleted=0 ORDER BY ragione_sociale", "value": "" ]}
		</div>
	</div>
