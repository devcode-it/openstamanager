...
$is_patrimoniale = $dbo->fetchOne('SELECT descrizione FROM co_pianodeiconti1 WHERE id=(SELECT id_piano_dei_conti1 FROM co_pianodeiconti2 WHERE id=(SELECT id_piano_dei_conti2 FROM co_pianodeiconti3 WHERE id='.prepare($id_conto).'))')['descrizione'] == 'Patrimoniale';
