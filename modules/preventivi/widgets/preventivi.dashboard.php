...
$id_module = (new Module())->getByField('title', 'Preventivi', Models\Locale::getPredefined()->id);

$rs = Preventivo::where('idstato', '=', (new Stato())->getByField('title', 'In lavorazione', Models\Locale::getPredefined()->id))->where('default_revision', '=', 1)->get();
