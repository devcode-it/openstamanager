...
<table class="table table-bordered table-hover table-condensed table-striped">
    ...
    <tr>
        <td>';
            ...
            $id_modulo_fattura = ($movimento['dir'] == 'entrata') ? (new Module())->getByField('name', 'Fatture di vendita', \Models\Locale::getPredefined()->id)->id_record : (new Module())->getByField('name', 'Fatture di acquisto', \Models\Locale::getPredefined()->id);
