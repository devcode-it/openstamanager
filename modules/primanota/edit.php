...
if (sizeof($rs_doc) > 0) {
    if (sizeof($rs_doc) == 1) {
        ...
        $id_modulo = ($rs[0]['dir'] == 'entrata') ? (new Module())->getByField('name', 'Fatture di vendita')->id_record : (new Module())->getByField('name', 'Fatture di acquisto'); ?>
            
            <div class="col-md-2">
                <br>
                <div class="btn-group">
                    <a href="<?php echo base_path(); ?>/editor.php?id_module=<?php echo (new Module())->getByField('name', 'Preventivi'); ?>&id_record=<?php echo $rs_doc[0]['iddocumento']; ?>" class="btn btn-info"><i class="fa fa-chevron-left"></i> <?php echo tr('Vai alla fattura'); ?></a>
