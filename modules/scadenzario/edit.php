...
$id_modulo_banche = (new Module())->getByField('name', 'Banche', \Models\Locale::where('predefined', true)->first()->id);
$id_modulo_prima_nota = (new Module())->getByField('name', 'Prima nota', \Models\Locale::where('predefined', true)->first()->id);
