...
$r = $dbo->fetchOne('SELECT 
    ...
    WHERE 
        `co_scadenzario`.`da_pagare` > `co_scadenzario`.`pagato` AND `co_scadenzario`.`id_documento` = (SELECT `id_documento` FROM `co_scadenzario` s WHERE `id`='.prepare($id_record).')
