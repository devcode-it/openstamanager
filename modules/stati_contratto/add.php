...
?><form action="" method="post" id="add-form">
	...
	<div class="row">
		<div class="col-md-2">
            {[ "type": "checkbox", "label": "<?php echo tr('Bloccato'); ?>", "name": "is_bloccato_add", "value": "$is_bloccato$", "help": "<?php echo tr('I contratti che si trovano in questo stato verranno considerati come completati'); ?>", "placeholder": "<?php echo tr('Bloccato'); ?>", "extra": "" ]}
		</div>
