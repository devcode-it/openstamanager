	...
	<div class="row">
		<div class="col-md-9">
			...
			<div class="row">
				...
				<!--inizio mod aggiunta campo sort_order-->
                <div class="col-md-3">
                    {[ "type": "text", "label": "<?php echo tr('Ordinamento'); ?>", "name": "sort_order", "help": "<?php echo tr('Ordine di Visualizzazione: numeri più bassi aumentano la priorità.'); ?>.", "value": "$sort_order$" ]}
				</div>
				<!--fine aggiunta campo-->
