...
echo '
        <div class="col-md-4">
            {[ "type": "select", "label": "'.tr('Unità di misura').'", "icon-after": "add|'.(new Module())->getByField('name', 'Unità di misura', \Models\Locale::where('predefined', true)->first()->id).'", "name": "um", "value": "'.$um.'", "ajax-source": "misure" ]}
        </div>';
