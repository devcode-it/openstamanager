...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs nav-justified">
        ...
        <li class="nav-item"><a class="nav-link" data-card-widget="tab" href="#filters">'.tr('Filtri').' <span class="badge badge-info">'.Clause::where('id_module', $record->id)->count().' </span></a></li>
    </ul>
    <br>
