...
$id_module_fattura = (new Module())->getByField('name', 'Fatture di vendita', \Models\Locale::where('predefined', true)->first()->id);
...
$modules = (new Module())->getByField('name', 'Contratti', \Models\Locale::where('predefined', true)->first()->id);
