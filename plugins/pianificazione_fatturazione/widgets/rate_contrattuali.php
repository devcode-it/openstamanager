...
$pianificazioni = Pianificazione::doesntHave('fattura')
    ...
    ->whereMonth('co_fatturazione_contratti.data_scadenza', date('m'))->get();
...
'<div class="row" style="margin:0px">
    <div class="col-12 text-right" style="margin:0px 10px;">
    ...
    <div class="div-month">';
        ...
        for ($i=1; $i<=12; $i++) {
            $btnType = ($i == date('m'))? "btn-primary" : "btn-light";
            echo
            '<div class="col-2 col-sm-2 col-md-1 text-center" style="margin:10px 0px; padding:0px;">
...
'<div style="display:none" class="template-month">
    <div class="col-2 col-sm-2 col-md-1 text-center" style="margin:10px 0px; padding:0px;">
        <a class="btn btn-month" style="cursor:pointer" onclick="month_click($(this))">
            <div class="text" style="margin:0"></div>
            <div class="text-count" style="margin:0"></div>
        </a>
    </div>
</div>';
?>
...
<div class="row" style="margin:20px 0px">
    ...
    <div class="col-lg-8" style="padding-left:0">
        ...
        <a class="btn btn-primary deseleziona-tutti"><?= tr('Deseleziona tutti') ?></a>
    </div>
</div>
...
'<div>
    <table id="tbl-rate" class="table-rate table table-hover table-striped">
        <thead>
            <tr>
                <th width="2%">'.tr('Seleziona').'</th>
                <th width="25%">'.tr('Entro il').'</th>
                <th width="33%">'.tr('Ragione sociale').'</th>
        ...
        <tbody>';
            ...
            foreach ($pianificazioni as $pianificazione) {
                ...
                <tr>
                    ...
                    <td>
                        <div style="margin:0">'.dateFormat($pianificazione->data_scadenza).'</div>
                    ...
                    <td>
                        <div style="margin:0">'.moneyFormat($pianificazione->totale).'</div>
