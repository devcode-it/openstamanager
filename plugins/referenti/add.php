...
<form action="" method="post" role="form">
	...
	<div class="row">
		...
		<div class="col-md-6">
			{[ "type": "select", "label": "'.tr('Mansione').'", "name": "idmansione", "ajax-source": "mansioni", "required": 1, "icon-after": "add|'.(new Module())->getByField('title', 'Mansioni referenti', Models\Locale::getPredefined()->id).'" ]}
		</div>
	</div>
