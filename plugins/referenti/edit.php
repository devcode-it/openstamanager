...
<form action="" method="post" role="form">
    ...
    <div class="row">
        <div class="col-md-6">
            {[ "type": "select", "label": "'.tr('Sede').'", "name": "id_sede", "values": "query=SELECT 0 AS id, \'Sede legale\' AS descrizione UNION SELECT id, CONCAT_WS(\' - \', nome_sede, citta) AS descrizione FROM an_sedi WHERE id_anagrafica='.$id_parent.'", "value" : "$id_sede$", "icon-after": "add|'.$id_module.'|id_plugin='.$id_plugin_sedi.'&id_parent='.$id_parent.'" ]}
        </div>
