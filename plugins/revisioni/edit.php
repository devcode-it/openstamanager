...
echo "
<form action='".base_path_osm().'/editor.php?id_module='.$id_module.'&id_record='.$id_record."' method='post'>
...
echo "
<form action='".base_path_osm().'/editor.php?id_module='.$id_module.'&id_record='.$id_record."' method='post' id='form_deleterevision'>
    <input type='hidden' name='backto' value='record-edit'>
