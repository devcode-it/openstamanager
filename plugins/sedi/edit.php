...
<form action="" method="post" role="form" id="form_sedi">
	...
	<div class="row">
		...
		<div class="col-md-4">
			{[ "type": "select", "label": "'.tr('Zona').'", "name": "idzona", "ajax-source": "zone",  "value": "$idzona$", "placeholder": "'.tr('Nessuna zona').'", "icon-after": "add|'.(new Module())->getByField('name', 'Zone', \Models\Locale::getPredefined()->id).'" ]}
		</div>
		<div class="col-md-4">
