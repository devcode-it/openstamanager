...
class AJAX
{
     ...
     * @return array
     */
    public static function select($resource, $elements = [], $search = null, $page = 0, $length = 100, $superselect = [])
    {
        if (!isset($elements)) {
            $elements = [];
        }
     ...
     * @return array|null
     */
    protected static function getSelectResults($file, $resource, $elements = [], $limit = [], $search = null, $superselect = [])
    {
        $where = [];
        $filter = [];
        $search_fields = [];
