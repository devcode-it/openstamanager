...
class VerificaAggiornamenti extends Resource implements RetrieveInterface
{
    ...
    private const RISORSE_DA_CONTROLLARE = [
        ...
        'articoli' => Articoli::class,
        'impianti' => Impianti::class,
        'contratti' => Contratti::class,
        'preventivi' => Preventivi::class,
        'sedi' => Sedi::class,
        'sedi-azienda' => SediAzienda::class,
        'referenti' => Referenti::class,
        'seriali' => Seriali::class,
        'sessioni' => SessioniInterventi::class,
        'righe-interventi' => RigheInterventi::class,
        'stati-intervento' => StatiIntervento::class,
        'tipi-intervento' => TipiIntervento::class,
        'tariffe-tecnici' => TariffeTecnici::class,
        'tariffe-contratti' => TariffeContratti::class,
        'aliquote-iva' => AliquoteIva::class,
        'campi-personalizzati' => CampiPersonalizzati::class,
        'campi-personalizzati-valori' => CampiPersonalizzatiValori::class,
