...
class OAuth2 extends Model
{
    ...
    public function getAccessToken()
    {
        ...
        return $this->attributes['access_token'] ? unserialize($this->attributes['access_token'], ['allowed_classes' => [AccessToken::class]]) : '';
    }
    ...
    {
        $access_token = $this->access_token ? unserialize($this->access_token, ['allowed_classes' => [AccessToken::class]]) : '';
