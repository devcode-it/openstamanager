...
$rs2 = $dbo->fetchArray('SELECT *, (SELECT nome FROM my_impianti WHERE id=my_impianti_interventi.id_impianto) AS nome, (SELECT matricola FROM my_impianti WHERE id=my_impianti_interventi.id_impianto) AS matricola FROM my_impianti_interventi WHERE id_intervento='.prepare($id_record));
$impianti = [];
...
<table class="table table-bordered vertical-middle">
    <tr>
        ...
        $impianti_collegati = $dbo->fetchArray('SELECT * FROM my_impianti_interventi INNER JOIN my_impianti ON my_impianti_interventi.id_impianto = my_impianti.id WHERE id_intervento = '.prepare($id_record));
