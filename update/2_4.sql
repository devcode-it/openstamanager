...
INSERT INTO `zz_settings` (`idimpostazione`, `nome`, `valore`, `tipo`, `editable`, `sezione`) VALUES (NULL, 'Metodologia calcolo ritenuta d''acconto predefinito', '', 'list[imponibile,imponibile_rivalsaimps]', '1', 'Fatturazione');