...
$fk_renames = [
    ...
    [
        'table' => 'em_newsletter_receiver',
        'old_fk' => 'em_newsletter_anagrafica_ibfk_4',
        'new_fk' => 'em_newsletter_receiver_ibfk_4',
        'column' => 'record_id',
        'ref_table' => 'an_anagrafiche',
        'ref_column' => 'idanagrafica',
        'on_delete' => 'CASCADE',
        'on_update' => 'RESTRICT',
    ],
    [
    ...
    [
        'table' => 'em_list_receiver',
        'old_fk' => 'em_list_anagrafica_ibfk_2',
        'new_fk' => 'em_list_receiver_ibfk_2',
        'column' => 'record_id',
        'ref_table' => 'an_anagrafiche',
        'ref_column' => 'idanagrafica',
        'on_delete' => 'CASCADE',
