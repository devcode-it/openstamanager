...
ALTER TABLE `in_interventi` DROP FOREIGN KEY `in_interventi_ibfk_10`; 
...
ALTER TABLE `in_interventi` DROP FOREIGN KEY `in_interventi_ibfk_11`;
...
ALTER TABLE `in_interventi` DROP FOREIGN KEY `in_interventi_ibfk_12`;
