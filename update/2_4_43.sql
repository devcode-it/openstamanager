...
UPDATE `zz_views` INNER JOIN `zz_modules` ON `zz_views`.`id_module` = `zz_modules`.`id` SET `zz_views`.`query` = 'IF(`an_anagrafiche`.`ragione_sociale` != "", `an_anagrafiche`.`ragione_sociale`, CONCAT(`an_anagrafiche`.`cognome`, " ", `an_anagrafiche`.`nome`))' WHERE `zz_modules`.`name` = 'Anagrafiche' AND `zz_views`.`name` = 'Ragione sociale';
UPDATE `zz_views` INNER JOIN `zz_modules` ON `zz_views`.`id_module` = `zz_modules`.`id` SET `zz_views`.`query` = 'IF(`an_anagrafiche`.`ragione_sociale` != "", `an_anagrafiche`.`ragione_sociale`, CONCAT(`an_anagrafiche`.`cognome`, " ", `an_anagrafiche`.`nome`))' WHERE `zz_modules`.`name` = 'Interventi' AND `zz_views`.`name` = 'Ragione sociale';
UPDATE `zz_views` INNER JOIN `zz_modules` ON `zz_views`.`id_module` = `zz_modules`.`id` SET `zz_views`.`query` = 'IF(`an_anagrafiche`.`ragione_sociale` != "", `an_anagrafiche`.`ragione_sociale`, CONCAT(`an_anagrafiche`.`cognome`, " ", `an_anagrafiche`.`nome`))' WHERE `zz_modules`.`name` = 'Fatture di vendita' AND `zz_views`.`name` = 'Ragione sociale';
UPDATE `zz_views` INNER JOIN `zz_modules` ON `zz_views`.`id_module` = `zz_modules`.`id` SET `zz_views`.`query` = 'IF(`an_anagrafiche`.`ragione_sociale` != "", `an_anagrafiche`.`ragione_sociale`, CONCAT(`an_anagrafiche`.`cognome`, " ", `an_anagrafiche`.`nome`))' WHERE `zz_modules`.`name` = 'Fatture di acquisto' AND `zz_views`.`name` = 'Ragione sociale';
UPDATE `zz_views` INNER JOIN `zz_modules` ON `zz_views`.`id_module` = `zz_modules`.`id` SET `zz_views`.`query` = 'IF(`an_anagrafiche`.`ragione_sociale` != "", `an_anagrafiche`.`ragione_sociale`, CONCAT(`an_anagrafiche`.`cognome`, " ", `an_anagrafiche`.`nome`))' WHERE `zz_modules`.`name` = 'Ordini cliente' AND `zz_views`.`name` = 'Ragione sociale';
UPDATE `zz_views` INNER JOIN `zz_modules` ON `zz_views`.`id_module` = `zz_modules`.`id` SET `zz_views`.`query` = 'IF(`an_anagrafiche`.`ragione_sociale` != "", `an_anagrafiche`.`ragione_sociale`, CONCAT(`an_anagrafiche`.`cognome`, " ", `an_anagrafiche`.`nome`))' WHERE `zz_modules`.`name` = 'Ordini fornitore' AND `zz_views`.`name` = 'Ragione sociale';
UPDATE `zz_views` INNER JOIN `zz_modules` ON `zz_views`.`id_module` = `zz_modules`.`id` SET `zz_views`.`query` = 'IF(`an_anagrafiche`.`ragione_sociale` != "", `an_anagrafiche`.`ragione_sociale`, CONCAT(`an_anagrafiche`.`cognome`, " ", `an_anagrafiche`.`nome`))' WHERE `zz_modules`.`name` = 'Ddt di vendita' AND `zz_views`.`name` = 'Ragione sociale';
UPDATE `zz_views` INNER JOIN `zz_modules` ON `zz_views`.`id_module` = `zz_modules`.`id` SET `zz_views`.`query` = 'IF(`an_anagrafiche`.`ragione_sociale` != "", `an_anagrafiche`.`ragione_sociale`, CONCAT(`an_anagrafiche`.`cognome`, " ", `an_anagrafiche`.`nome`))' WHERE `zz_modules`.`name` = 'Ddt di acquisto' AND `zz_views`.`name` = 'Ragione sociale';
UPDATE `zz_views` INNER JOIN `zz_modules` ON `zz_views`.`id_module` = `zz_modules`.`id` SET `zz_views`.`query` = 'IF(`an_anagrafiche`.`ragione_sociale` != "", `an_anagrafiche`.`ragione_sociale`, CONCAT(`an_anagrafiche`.`cognome`, " ", `an_anagrafiche`.`nome`))' WHERE `zz_modules`.`name` = 'Listini' AND `zz_views`.`name` = 'Ragione sociale';