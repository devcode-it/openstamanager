...
$module = $dbo->fetchOne('SELECT * FROM zz_modules WHERE name = ?', ['Fatture di acquisto']);
$directory = 'files/fatture/vendite/';
$files = glob($directory.'*.{xml,pdf}', GLOB_BRACE) ?: [];
$new_folder = 'files/'.$module['attachments_directory'].'/';
directory($new_folder);

$attachments = $dbo->fetchArray('SELECT `filename` FROM `zz_files` WHERE `id_module` = ?', [$module['id']]) ?: [];
...
// Rinomina FK per tabelle rinominate mg_categorie -> zz_categorie e mg_categorie_lang -> zz_categorie_lang
$fk_renames = [
    [
        'table' => 'zz_categorie',
        'old_fk' => 'mg_categorie_ibfk_1',
        'new_fk' => 'zz_categorie_ibfk_1',
        'column' => 'parent',
        'ref_table' => 'zz_categorie',
        'ref_column' => 'id',
        'on_delete' => 'CASCADE',
        'on_update' => 'RESTRICT',
    ],
    [
        'table' => 'zz_categorie_lang',
        'old_fk' => 'mg_categorie_lang_ibfk_1',
        'new_fk' => 'zz_categorie_lang_ibfk_1',
        'column' => 'id_record',
        'ref_table' => 'zz_categorie',
        'ref_column' => 'id',
        'on_delete' => 'CASCADE',
    ...
    [
        'table' => 'zz_categorie_lang',
        'old_fk' => 'mg_categorie_lang_ibfk_2',
        'new_fk' => 'zz_categorie_lang_ibfk_2',
        'column' => 'id_lang',
        'ref_table' => 'zz_langs',
        'ref_column' => 'id',
        'on_delete' => 'CASCADE',
