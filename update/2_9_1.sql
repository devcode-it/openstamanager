...
((SELECT `id` FROM `zz_modules` WHERE `name` = 'Gestione task'), '_bg_', 'IF(`zz_tasks`.`enabled`=1, \'#dff0d8\', \'#f2dede\')', '0', '0', '0', '0', '0', NULL, NULL, '0', '0', '0', '1');

INSERT INTO `zz_views_lang` (`id_lang`, `id_record`, `title`) VALUES
(1, (SELECT `id` FROM `zz_views` WHERE `id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Gestione task') AND `name` = '_bg_'), '_bg_'),
(2, (SELECT `id` FROM `zz_views` WHERE `id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Gestione task') AND `name` = '_bg_'), '_bg_');
...
('1', (SELECT MAX(id) FROM `zz_tasks`), 'Hook Email'),
('2', (SELECT MAX(id) FROM `zz_tasks`), 'Email Hook');
...
INSERT INTO `zz_tasks_lang` (`id_lang`, `id_record`, `title`) VALUES
('1', (SELECT MAX(id) FROM `zz_tasks`), 'Hook Aggiornamenti'),
('2', (SELECT MAX(id) FROM `zz_tasks`), 'Updates Hook');
...
INSERT INTO `zz_tasks_lang` (`id_lang`, `id_record`, `title`) VALUES
('1', (SELECT MAX(id) FROM `zz_tasks`), 'Hook Spazio disponibile'),
('2', (SELECT MAX(id) FROM `zz_tasks`), 'Space Hook');
...
INSERT INTO `zz_tasks_lang` (`id_lang`, `id_record`, `title`) VALUES
('1', (SELECT MAX(id) FROM `zz_tasks`), 'Hook Informazioni su Services'),
('2', (SELECT MAX(id) FROM `zz_tasks`), 'Services Hook');
...
INSERT INTO `zz_tasks_lang` (`id_lang`, `id_record`, `title`) VALUES
('1', (SELECT MAX(id) FROM `zz_tasks`), 'Hook Invio Fatture Elettroniche'),
('2', (SELECT MAX(id) FROM `zz_tasks`), 'Electronic Invoices Hook');
...
INSERT INTO `zz_tasks_lang` (`id_lang`, `id_record`, `title`) VALUES
('1', (SELECT MAX(id) FROM `zz_tasks`), 'Hook Importazione Fatture Elettroniche'),
('2', (SELECT MAX(id) FROM `zz_tasks`), 'Electronic Invoices Import Hook');
